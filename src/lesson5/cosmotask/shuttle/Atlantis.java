...
public class Atlantis implements IStart {
    ...
    public void engineStart() {
        System.out.println("Двигатели Шатла Atlantis запущены. Все системы в норме.");
    }

    @Override
    public void start() {
        System.out.println("Старт Шатла Atlantis");
    }
}
